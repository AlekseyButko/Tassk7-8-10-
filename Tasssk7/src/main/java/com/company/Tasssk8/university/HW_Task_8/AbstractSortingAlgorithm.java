package com.company.Tasssk8.university.HW_Task_8;
...
public abstract class AbstractSortingAlgorithm {
    ...
    public void startFrequency(File file, SortEnum comparator) throws IOException {
        this.file = file;
        String str = "";
        if (file.exists())
...
//    public void startFrequency1(File str, SortEnum comparator) throws FileNotFoundException {
